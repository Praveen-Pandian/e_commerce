...
export default function SignupMid() {
  ...
  async function udb(e)
  {
    ...
    const obj={"userid": currentUser.email ,"name": nameRef.current.value,"address": addressRef.current.value,"interest":interestRef.current.value };
    console.log(obj);
    await set(ref(db, 'users/'+currentUser.uid), obj);
